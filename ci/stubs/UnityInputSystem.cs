// Minimal compile-time stubs for Unity.InputSystem types used by AimAssist.
...
namespace UnityEngine.InputSystem
{
    ...
    public class Keyboard : InputControl
    {
        public static Keyboard? current { get; }
        public ButtonControl this[Key key] => new ButtonControl();
        public ButtonControl anyKey       => new ButtonControl();
    }

    public class Mouse : InputControl
    {
        public static Mouse?   current       { get; }
        public ButtonControl   leftButton    => new ButtonControl();
        public ButtonControl   rightButton   => new ButtonControl();
        public ButtonControl   middleButton  => new ButtonControl();
        public ButtonControl   backButton    => new ButtonControl();
        public ButtonControl   forwardButton => new ButtonControl();
    }
}
